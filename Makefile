...
clean-deps:
	...
	rm -rf lib/jQuery-ajaxTransport-XDomainRequest/current
...
deploy: clean-deps
	...
	git clone git://github.com/MoonScript/jQuery-ajaxTransport-XDomainRequest.git lib/jQuery-ajaxTransport-XDomainRequest/current
