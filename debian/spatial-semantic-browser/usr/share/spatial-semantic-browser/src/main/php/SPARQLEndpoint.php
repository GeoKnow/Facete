...
private function _getFormat($format=null){
 ...
 public function executeQuery($query, $defaultGraphURI=null, $format=null){
	 ...
	 * */
public function executeCount($query, $defaultGraphURI=null, $format=null){
				//Timer::start($logComponent.'::http::count');
				$json = $this->executeQuery($query, $defaultGraphURI, $format);
