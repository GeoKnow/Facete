...
RDFA.getNodeAttributeValueNS = function (element, attr, namespace, currentNamespaces) {
    // (DOM Level 2): Safari, Chrome, FF, Opera
    if (element.hasAttributeNS && element.getAttributeNS) {
        if (element.hasAttributeNS(namespace, attr)) {
...
RDFA.traverse = function (element, subject, namespaces, oldLang, base, hanging, graph) {
    ...
    if (attrs['rel'] != null || attrs['rev'] != null || attrs['property'] || attrs['typeof'] != null) {
        graph = newGraph;
    }
