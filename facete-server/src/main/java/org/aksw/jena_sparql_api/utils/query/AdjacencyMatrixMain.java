package org.aksw.jena_sparql_api.utils.query;
...
import org.aksw.sparql_path.utils.ElementUtils;
...
public class AdjacencyMatrixMain {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		QueryExecutionFactory qef1 = new QueryExecutionFactoryHttp("http://dbpedia.org/sparql");
		...
		QueryExecutionFactory qef2 = new QueryExecutionFactoryHttp("http://dbpedia.org/sparql");
