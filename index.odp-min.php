...
<!--         <link rel="stylesheet" type="text/css" href=" target/semmap-0.1-SNAPSHOT/css/SemMap.min.css" /> -->
...
<!-- 		src="http://www.openstreetmap.org/openlayers/OpenStreetMap.js"></script> -->
	...
	<!-- Configuration files -->
 	<script type="text/javascript" src="target/semmap-0.1-SNAPSHOT/js/SemMap.min.js"></script>
