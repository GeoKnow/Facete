(function() {
	...
	/**
	 * Fetches the resources at the navigation path, thereby counting the number of distinct objects
	 * 
	 ...
	 */
	/*
	ns.QueryExecutor.prototype.fetchCountDistinctObjects = function(sampleLimit, options) {
		...
		// TODO: this should be something like createQueryCountNavigationDistinctObjects
	...
	*/
	...
	/**
	 * 
	 * @param isInverse Whether to fetch the incoming facets
	 * @param sampleLimit
	 * @param options
	 */
	ns.QueryExecutor.prototype.fetchCountDistinctFacets = function(isInverse, sampleLimit, options) {
		
		var facetVar = sparql.Node.v("__f");
		var facetCountVar = sparql.Node.v("__c");
		var query = this.queryGenerator.createQueryCountDistinctFacets(facetVar, facetCountVar, isInverse, sampleLimit, options);
