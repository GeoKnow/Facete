...
//	 * Or should it become passed as an argument when actually creating queries? 
	...
	ns.QueryGenerator.prototype = {
			...
			setNavigationPath: function(path) {
			 ...
			 * 
			 */
			copyExcludeConstraints: function(paths) {
		...
		*/
			...
			copyExcludeConstraint: function(path) {
			 ...
			 * @param path
			 */
			copyNavigate: function(navigationPath) {
			 ...
			 * 
			 */
			fixConstraints: function() {
				// TODO If this method seems useful, implement it.
			},
			
			
			navigateToFacets: function(direction) {
			 ...
			 * @param direction
			 */
			navigateToFacetValues: function(propertyName, isInverse) {
			...
			createDriverFacetValues: function(path) {
			...
			getNavigationVariable: function() {
			 ...
			 */
			createQueryCountNavigation: function(countVar, sampleLimit, options) {
			 ...
			 * ns.createQueryCount = function(element, limit, variable, outputVar, groupVars)
			 */
			createQueryCountNavigationDistinctTargets: function(countVar, sampleLimit, options) {
				var element = this.createElement();
			...
			createDriverValues: function(options) {
				var element = this.createElement();
			...
			createQueryCountValues: function(countVar, sampleLimit, options) {
				var concept = this.createDriverValues();
			...
			createQueryValues: function(options) {
				var concept = this.createDriverValues();
			...
			filterRegex: function(regexStr, flags, relativePath) {
				if(!relativePath) {
			...
			_appendConstraintElement: function(destElements, options) {
